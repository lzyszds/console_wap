<script setup>
import { addData, editData, getDataList, deleteData } from "@/api/task/tiktok/post";
...
const textString = "navigation.dashboard.taskParams.tiktok.children.post.";
...
provide("paramsData", {
  ...
  tableTitle: [
    ...
    {
      prop: "upload_type",
      label: () => getLabel("upload_type"),
      template: (row) => {
        return row.upload_type == "0"
          ? getLabel("upload_type_list.0")
          : getLabel("upload_type_list.1");
      },
    },
    {
