...
const textString = "navigation.dashboard.resourceManagement.children.video.";
...
async function getDataListFn() {
  let response = await getVideoList(listQuery);
    ...
    <div class="content">
      ...
      >
        ...
        <div class="card-video">
          <video class="card-video-player" :src="item.url" controls muted></video>
